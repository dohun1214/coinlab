...
<body>
	<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 mb-6">
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-blue-500 rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-BTC">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-ETH">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-SOL">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-XRP">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-ADA">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-AVAX">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-DOT">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-ARB">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-ATOM">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-APT">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-UNI">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-AAVE">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-LINK">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-SAND">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-DOGE">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-SHIB">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-PEPE">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-USDT">
		...
		<div class="coin-box bg-gray-700 hover:bg-gray-600 border-2 border-transparent rounded-lg p-3 cursor-pointer transition-all text-center" data-code="KRW-USDC">
